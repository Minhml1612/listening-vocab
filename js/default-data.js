...
window.DEFAULT_VOCAB_DATA = [
  {
    ...
    "oxfordExamples": [
      ...
      {
        "en": "Tears were pouring down his face as he waved goodbye.",
        "vi": "Nước mắt giàn giụa tuôn rơi trên má anh ấy khi vẫy tay chào tạm biệt."
      },
      {
        "en": "Pour the sauce over the cooked pasta and serve immediately.",
        "vi": "Rưới nước sốt lên đĩa mì ống nóng và thưởng thức ngay."
      }
    ],
    "collocations": [
      "pour sth into/from/out of sth",
  ...
  },
  {
    ...
    "oxfordExamples": [
      ...
      {
        "en": "I deeply regret what I said to you yesterday in anger.",
        "vi": "Tôi vô cùng ân hận về những lời mình đã nói trong lúc nóng giận hôm qua."
      },
      {
        "en": "She expressed sincere regret for the unintended delay.",
        "vi": "Cô ấy bày tỏ sự tiếc nuối chân thành vì sự chậm trễ ngoài ý muốn."
      }
    ],
    "collocations": [
      "deeply / bitterly regret",
      "regret doing sth",
      "have no regrets",
      "express deep regret"
    ],
  ...
  },
  {
    ...
    "oxfordExamples": [
      ...
      {
        "en": "A strange man was seen wandering around the neighborhood.",
        "vi": "Một người đàn ông lạ mặt được trông thấy đang đi lang thang quanh khu phố."
      },
      {
        "en": "It's strange that he hasn't returned any of my calls.",
        "vi": "Thật kỳ lạ là anh ấy không hề gọi lại bất kỳ cuộc gọi nào của tôi."
      }
    ],
    "collocations": [
  ...
  },
  {
    ...
    "oxfordExamples": [
      ...
      {
        "en": "I felt terribly guilty about leaving the cat alone all weekend.",
        "vi": "Tôi cảm thấy vô cùng có lỗi khi để chú mèo ở nhà một mình suốt cả cuối tuần."
      },
      {
        "en": "The jury unanimously found the defendant guilty of fraud.",
        "vi": "Bồi thẩm đoàn đã nhất trí tuyên bố bị cáo có tội lừa đảo."
      }
    ],
    "collocations": [
  ...
  },
  {
    ...
    "oxfordExamples": [
      ...
      {
        "en": "Hundreds of eager customers stood in line overnight outside the store.",
        "vi": "Hàng trăm khách hàng háo hức đã xếp hàng thâu đêm bên ngoài cửa hàng."
      }
    ],
    "collocations": [
  ...
  },
  {
    ...
    "oxfordExamples": [
      ...
      {
        "en": "He nodded his head in friendly greeting as he passed by.",
        "vi": "Anh ấy gật đầu chào thân thiện khi đi ngang qua."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Khả năng nói tiếng Anh trôi chảy là một yêu cầu thiết yếu cho vị trí bán hàng quốc tế này."
      },
      {
        "en": "Applicants must fulfill all academic requirements before graduation.",
        "vi": "Tất cả các ứng viên phải hoàn thành tất cả các yêu cầu học thuật trước khi tốt nghiệp."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Bộ phận hỗ trợ khách hàng cam kết đáp ứng mọi thắc mắc trong vòng 24 giờ."
      },
      {
        "en": "The patient is responding remarkably well to the new treatment.",
        "vi": "Bệnh nhân đang đáp ứng rất tốt với phương pháp điều trị mới."
      }
    ],
    "collocations": [
      "respond to sth",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Định dạng bài thi nghe mới được cho là dễ hơn nhiều so với kỳ thi trước đó."
      },
      {
        "en": "This restaurant is supposedly the best Italian eatery in the city.",
        "vi": "Nhà hàng này được cho là quán ăn Ý ngon nhất trong thành phố."
      }
    ],
    "collocations": [
      "supposedly superior",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Đừng mắc bẫy những tiêu đề giật gân trên mạng xã hội; phần lớn chúng chỉ là trò câu view rẻ tiền."
      },
      {
        "en": "The website uses deceptive clickbait articles to boost its advertising revenue.",
        "vi": "Trang web này sử dụng các bài báo giật gân câu view để tăng doanh thu quảng cáo."
      }
    ],
    "collocations": [
      "pure clickbait",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Bạn nên sắp xếp lịch ôn tập hàng ngày một cách khôn ngoan để đạt mục tiêu điểm số."
      },
      {
        "en": "She invested her savings wisely in green energy stocks.",
        "vi": "Cô ấy đã đầu tư số tiền tiết kiệm của mình một cách khôn ngoan vào cổ phiếu năng lượng xanh."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Đột nhiên, chuông báo cháy reo lên ngay giữa lúc chúng tôi đang làm bài kiểm tra nghe."
      },
      {
        "en": "Suddenly, all the lights in the building went out.",
        "vi": "Bất thình lình, toàn bộ đèn trong tòa nhà đều vụt tắt."
      }
    ],
    "collocations": [
      "suddenly realize",
  ...
  },
  {
    ...
    "oxfordExamples": [
      ...
      {
        "en": "It doesn't matter what people think of your hobbies.",
        "vi": "Người khác nghĩ gì về sở thích của bạn không hề quan trọng."
      }
    ],
    "collocations": [
      "does it matter?",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Anh ấy đã có may mắn được hướng dẫn bởi một trong những giáo sư tiếng Anh hàng đầu đất nước."
      },
      {
        "en": "He made a huge fortune by developing mobile apps.",
        "vi": "Anh ấy đã kiếm được cả một gia tài nhờ phát triển các ứng dụng di động."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Một người đáng tin cậy sẽ không bao giờ phản bội niềm tin và bí mật mà bạn bè chia sẻ."
      },
      {
        "en": "He felt that his closest friend had betrayed his trust.",
        "vi": "Anh cảm thấy người bạn thân nhất đã phản bội lòng tin của mình."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Cô ấy đã vượt qua bài thi nghe IELTS ở lần nỗ lực thứ hai với điểm số ấn tượng."
      },
      {
        "en": "Two prisoners made an escape attempt last night.",
        "vi": "Hai tù nhân đã cố gắng vượt ngục đêm qua."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Hội đồng thành phố đã đồng ý xây dựng một cây cầu dành cho người đi bộ bắc qua xa lộ tắc nghẽn."
      },
      {
        "en": "The iconic suspension bridge spans across the wide river.",
        "vi": "Cây cầu treo biểu tượng bắc qua dòng sông rộng lớn."
      }
    ],
    "collocations": [
      "cross a bridge",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Chúng tôi đã bỏ bữa sáng và luyện nghe suốt năm tiếng, nên giờ đói cồn cào cả ruột."
      },
      {
        "en": "When will lunch be ready? I'm absolutely starving!",
        "vi": "Khi nào bữa trưa mới xong vậy? Tôi đang đói rã rời rồi!"
      }
    ],
    "collocations": [
      "I'm starving!",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Trong văn nói bình dân đường phố, người ta đôi khi xúc phạm người khác bằng từ ngữ này."
      },
      {
        "en": "He apologized sincerely for acting like an asshole during the heated debate.",
        "vi": "Anh ấy đã thành thật xin lỗi vì hành xử thô lỗ trong cuộc tranh luận gay gắt."
      }
    ],
    "collocations": [
      "act like an asshole",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Tôi thề rằng tôi đã nói với cảnh sát toàn bộ sự thật về những gì đã xảy ra đêm qua."
      },
      {
        "en": "Witnesses are required to swear an oath in court.",
        "vi": "Các nhân chứng được yêu cầu phải tuyên thệ trước tòa án."
      }
    ],
    "collocations": [
      "swear to do sth",
  ...
  },
  {
    ...
    "oxfordExamples": [
      ...
      {
        "en": "The soccer team proudly displayed their championship trophy.",
        "vi": "Đội bóng đá tự hào trưng bày chiếc cúp vô địch của họ."
      }
    ],
    "collocations": [
      "win / lift a trophy",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Khi giáo viên bất ngờ gọi hỏi đáp án, đầu óc anh ấy bỗng trở nên hoàn toàn trống rỗng."
      },
      {
        "en": "Leave this section blank if you do not have any dependents.",
        "vi": "Hãy để trống phần này nếu bạn không có người phụ thuộc nào."
      }
    ],
    "collocations": [
      "mind went blank",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Nhà hàng khách sạn hoàn toàn vắng tanh vì tất cả khách đã đi tour trong ngày."
      },
      {
        "en": "The streets were completely empty after midnight.",
        "vi": "Đường phố hoàn toàn vắng bóng người sau nửa đêm."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Thật là phản tác dụng khi tranh cãi về những chi tiết nhỏ trong khi ngày mai chúng ta có hạn chót lớn."
      },
      {
        "en": "They argued endlessly over who should pay the restaurant bill.",
        "vi": "Họ tranh cãi không dứt về việc ai nên trả hóa đơn nhà hàng."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Bạn nên sử dụng ngôn ngữ trang trọng và kính ngữ thích hợp khi viết một bài luận học thuật."
      },
      {
        "en": "He wore a formal dark suit to the diplomatic banquet.",
        "vi": "Anh ấy mặc một bộ âu phục trang trọng màu tối tới bữa tiệc ngoại giao."
      }
    ],
    "collocations": [
      "formal attire / dress",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Hơn năm trăm chuyên gia y tế đã tập hợp tại Geneva để tham dự hội nghị khoa học hàng năm."
      },
      {
        "en": "She gave an inspiring presentation at the international conference.",
        "vi": "Cô ấy đã có bài thuyết trình truyền cảm hứng tại hội nghị quốc tế."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Cô ấy đã nhận được sự kính trọng to lớn từ cả các đồng nghiệp cấp dưới và cấp trên trong phòng ban."
      },
      {
        "en": "My colleagues and I meet every Monday morning to review weekly goals.",
        "vi": "Tôi và các đồng nghiệp gặp nhau vào sáng thứ Hai hàng tuần để xem lại mục tiêu trong tuần."
      }
    ],
    "collocations": [
      "work colleagues",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Sinh viên đại học năm cuối thường trải qua áp lực to lớn khi chuẩn bị cho buổi bảo vệ luận án."
      },
      {
        "en": "He works exceptionally well under intense pressure.",
        "vi": "Anh ấy làm việc đặc biệt hiệu quả dưới áp lực căng thẳng."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Gã khổng lồ công nghệ sẽ chính thức phát hành hệ điều hành mới vào đầu tháng tới."
      },
      {
        "en": "The band recently released their fifth studio album to critical acclaim.",
        "vi": "Ban nhạc gần đây đã phát hành album phòng thu thứ năm và nhận được nhiều lời khen ngợi."
      }
    ],
    "collocations": [
      "officially release",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Bạn có thể vui lòng chỉ cho tôi phòng thử đồ ở đâu để tôi thử chiếc quần jean này được không?"
      },
      {
        "en": "There was a short queue outside the women's fitting room.",
        "vi": "Có một hàng đợi ngắn bên ngoài phòng thử đồ nữ."
      }
    ],
    "collocations": [
      "in the fitting room",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Cô được thừa kế một bộ sưu tập trang sức kim cương cổ có giá trị từ bà của mình."
      },
      {
        "en": "The store specializes in handcrafted silver jewelry.",
        "vi": "Cửa hàng chuyên về các loại đồ trang sức bạc làm thủ công."
      }
    ],
    "collocations": [
      "wear / buy jewelry",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Bưu điện cung cấp dịch vụ chuyển tiếp thư từ khi bạn chuyển đến căn hộ mới."
      },
      {
        "en": "Please set up email forwarding so you don't miss urgent notices.",
        "vi": "Vui lòng cài đặt chuyển tiếp email để bạn không bỏ lỡ các thông báo khẩn cấp."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Chúng tôi đã đặt tour du lịch qua một đại lý du lịch uy tín ở trung tâm London."
      },
      {
        "en": "An estate agent showed us several apartments in the neighborhood.",
        "vi": "Một nhân viên môi giới bất động sản đã dẫn chúng tôi đi xem vài căn hộ trong khu vực."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Một tính năng nổi bật của chiếc máy tính xách tay này là thời lượng pin cực dài tới hai mươi giờ."
      },
      {
        "en": "The new phone features an advanced triple-lens camera system.",
        "vi": "Chiếc điện thoại mới sở hữu hệ thống camera 3 ống kính tiên tiến."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Vào mỗi tháng mười một, cả quốc gia tưởng nhớ những anh hùng đã ngã xuống hy sinh mạng sống trong chiến tranh."
      },
      {
        "en": "Fallen leaves covered the garden path in vibrant shades of gold.",
        "vi": "Những chiếc lá rụng phủ kín lối đi trong vườn với sắc vàng rực rỡ."
      }
    ],
    "collocations": [
  ...
  },
  {
    ...
    "oxfordExamples": [
      ...
      {
        "en": "She loves shopping for vintage clothes in thrift shops.",
        "vi": "Cô ấy thích tìm mua quần áo phong cách cổ điển tại các cửa hàng đồ cũ."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Với sự trỗi dậy của điện thoại thông minh, máy nhắn tin và đĩa mềm truyền thống đã hoàn toàn trở nên lỗi thời."
      },
      {
        "en": "New technological advancements quickly make older machinery obsolete.",
        "vi": "Những bước tiến công nghệ mới nhanh chóng biến máy móc cũ kỹ thành đồ lỗi thời."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Tôi xin lỗi, màu đó hôm nay đã hết hàng, nhưng kho của chúng tôi sẽ có hàng vào ngày mai."
      },
      {
        "en": "The bookstore currently has ten copies in stock.",
        "vi": "Hiệu sách hiện có sẵn mười cuốn trong kho."
      }
    ],
    "collocations": [
      "available in stock",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Vì thường xuyên ốm đau, anh ấy đã bị đánh dấu là người vắng mặt trong gần một tháng."
      },
      {
        "en": "High absentee rates can severely disrupt the manufacturing schedule.",
        "vi": "Tỷ lệ vắng mặt cao có thể làm gián đoạn nghiêm trọng lịch trình sản xuất."
      }
    ],
    "collocations": [
      "chronic absentee",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Nhà hát Opera Sydney được công nhận rộng rãi là một thắng cảnh mang tính biểu tượng của nước Úc."
      },
      {
        "en": "She wore an iconic little black dress designed by Chanel.",
        "vi": "Cô ấy diện một chiếc đầm đen biểu tượng do Chanel thiết kế."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Anh ấy đã dành sáu tháng để nuôi một bộ râu rậm rạp, được chải chuốt cẩn thận cho vai diễn trong phim lịch sử."
      },
      {
        "en": "He decided to shave off his beard for the summer.",
        "vi": "Anh ấy quyết định cạo sạch bộ râu cho mùa hè mát mẻ."
      }
    ],
    "collocations": [
      "grow / trim a beard",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Vị giáo sư đại học cảm thấy vô cùng vinh hạnh khi được mời làm diễn giả chính tại hội nghị thượng đỉnh."
      },
      {
        "en": "I am honored to accept this award on behalf of our hardworking team.",
        "vi": "Tôi rất vinh hạnh được nhận giải thưởng này thay mặt cho toàn bộ đội ngũ chăm chỉ của chúng tôi."
      }
    ],
    "collocations": [
      "feel deeply honored",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Vào mùa đông khắc nghiệt, những cây sồi cao trong công viên trơ trụi hoàn toàn không còn một chiếc lá."
      },
      {
        "en": "She walked with bare feet along the warm sandy beach.",
        "vi": "Cô ấy đi chân trần dọc theo bãi biển cát ấm áp."
      }
    ],
    "collocations": [
      "bare hands / feet",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Tính phức tạp về mặt pháp lý của thỏa thuận sáp nhập đòi hỏi sự tư vấn từ các luật sư doanh nghiệp hàng đầu."
      },
      {
        "en": "Scientists are exploring the complexity of human brain networks.",
        "vi": "Các nhà khoa học đang khám phá sự phức tạp của các mạng lưới não bộ con người."
      }
    ],
    "collocations": [
      "sheer complexity",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Đội ngũ xây dựng đã sử dụng cần cẩu để nâng một thanh dầm thép khổng lồ lên kết cấu cầu."
      },
      {
        "en": "The novel was a massive success, selling millions of copies worldwide.",
        "vi": "Cuốn tiểu thuyết là một thành công vang dội khổng lồ, bán được hàng triệu bản trên toàn thế giới."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Sự tận tâm và khả năng lãnh đạo xuất sắc đã giúp cô ấy nhanh chóng được thăng chức lên vị trí giám đốc cấp cao."
      },
      {
        "en": "The supermarket is running a special promotion on dairy products this week.",
        "vi": "Siêu thị đang triển khai chương trình khuyến mãi đặc biệt cho các sản phẩm từ sữa tuần này."
      }
    ],
    "collocations": [
      "win / get a promotion",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Anh ấy đã dành nhiều năm lên kế hoạch trả thù những đối tác tha hóa đã từng phản bội mình."
      },
      {
        "en": "Revenge is a dish best served cold, as the old proverb says.",
        "vi": "Người xưa thường nói trả thù là món ăn ngon nhất khi để nguội."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Xói mòn đất nghiêm trọng là một hậu quả tất yếu của nạn phá rừng tràn lan trong khu vực."
      },
      {
        "en": "You must be prepared to accept the consequences of your careless decisions.",
        "vi": "Bạn phải sẵn sàng chấp nhận những hậu quả từ những quyết định bất cẩn của mình."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Cảnh sát giao thông đã phải chuyển hướng các phương tiện ra khỏi đại lộ do vụ rò rỉ khí gas bất ngờ."
      },
      {
        "en": "Incoming website visitors were automatically redirected to the new landing page.",
        "vi": "Khách truy cập vào trang web đã được tự động chuyển hướng sang trang đích mới."
      }
    ],
    "collocations": [
      "redirect traffic",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Bản thảo viết tay cổ đại vẫn thuộc quyền sở hữu của thư viện hoàng gia trong nhiều thế kỷ."
      },
      {
        "en": "He packed all his personal possessions into a single leather suitcase.",
        "vi": "Anh ấy đã thu dọn toàn bộ đồ đạc sở hữu cá nhân vào một chiếc vali da duy nhất."
      }
    ],
    "collocations": [
      "in possession of",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Chúng tôi đã bị kẹt trong thang máy bị hỏng gần bốn mươi phút trước khi các kỹ thuật viên đến."
      },
      {
        "en": "I'm completely stuck on question five of the math exam.",
        "vi": "Tôi hoàn toàn bị tắc tị ở câu số năm của bài thi toán."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Mức chuyên cần tối thiểu tám mươi phần trăm là bắt buộc để đủ điều kiện thi kết thúc học phần."
      },
      {
        "en": "A valid passport is required for all passengers traveling abroad.",
        "vi": "Hộ chiếu hợp lệ là giấy tờ bắt buộc đối với mọi hành khách đi du lịch nước ngoài."
      }
    ],
    "collocations": [
      "strictly required",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Tuần định hướng mang lại cho các sinh viên quốc tế mới nhập học nhiều thời gian để làm quen với khuôn viên trường."
      },
      {
        "en": "I spent my first few days on the job getting acquainted with the software.",
        "vi": "Tôi đã dành vài ngày đầu tiên đi làm để làm quen với phần mềm này."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Sau khi tập luyện hăng say tại phòng tập, tôi có cảm giác thèm không cưỡng lại được một ly sinh tố tươi mát."
      },
      {
        "en": "Pregnant women often experience sudden intense food cravings.",
        "vi": "Phụ nữ mang thai thường trải qua những cơn thèm ăn dữ dội bất ngờ."
      }
    ],
    "collocations": [
      "craving for sth",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Với sự cống hiến vượt bậc và đạo đức làm việc vững vàng, anh ấy chắc chắn sẽ đạt được thành công lớn."
      },
      {
        "en": "You are bound to feel nervous before giving a big speech.",
        "vi": "Bạn nhất định sẽ cảm thấy hồi hộp trước khi có một bài phát biểu quan trọng."
      }
    ],
    "collocations": [
      "bound to do sth",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Tổ chức từ thiện phi lợi nhuận hoạt động không mệt mỏi để đưa các cộng đồng nông nghiệp nông thôn thoát khỏi đói nghèo kinh niên."
      },
      {
        "en": "Millions of families still live below the international poverty line.",
        "vi": "Hàng triệu gia đình vẫn đang phải sống dưới chuẩn nghèo quốc tế."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Đừng chú ý đến những tin đồn mê tín trên mạng; chúng hoàn toàn là chuyện nhảm nhí vớ vẩn."
      },
      {
        "en": "What utter nonsense! That makes no logical sense.",
        "vi": "Thật là hoàn toàn vô lý nhảm nhí! Điều đó chẳng có chút logic nào cả."
      }
    ],
    "collocations": [
      "talk nonsense",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Quân đội đã mở một đợt phản công mạnh mẽ để tái chiếm thành trì chiến lược trên đỉnh đồi."
      },
      {
        "en": "The film vividly recaptures the magical atmosphere of 1920s Paris.",
        "vi": "Bộ phim đã tái hiện một cách sống động bầu không khí kỳ diệu của Paris những năm 1920."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Đồng tiền vàng cổ đại được phát hiện trong tàn tích được ước tính có giá trị hàng ngàn bảng Anh."
      },
      {
        "en": "The museum is definitely worth a visit if you have time.",
        "vi": "Bảo tàng này chắc chắn rất đáng để ghé thăm nếu bạn có thời gian."
      }
    ],
    "collocations": [
      "well worth doing",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Một giáo viên giỏi khuyến khích học sinh học hỏi từ sai lầm hơn là coi thường nỗ lực của các em."
      },
      {
        "en": "She never belittled her colleagues, even when disagreements arose.",
        "vi": "Cô ấy không bao giờ hạ thấp đồng nghiệp của mình, ngay cả khi nảy sinh bất đồng."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Có chủ đề cụ thể nào mà bạn muốn chúng ta ôn tập trong buổi hội thảo hôm nay không?"
      },
      {
        "en": "In this particular case, exceptions can be made.",
        "vi": "Trong trường hợp cụ thể này, có thể đưa ra những ngoại lệ."
      }
    ],
    "collocations": [
      "in particular",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Sự lan tràn nhanh chóng của rác thải nhựa trong đại dương đã trở thành một mối bận tâm môi trường lớn."
      },
      {
        "en": "Parents naturally express deep concern for their children's safety.",
        "vi": "Các bậc cha mẹ đương nhiên bày tỏ sự quan tâm sâu sắc đến sự an toàn của con cái."
      }
    ],
    "collocations": [
      "cause / voice concern",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Bác sĩ cam đoan với cô rằng xét nghiệm y tế này hoàn toàn chỉ là một biện pháp phòng ngừa."
      },
      {
        "en": "I met him purely by chance at the airport yesterday.",
        "vi": "Tôi gặp anh ấy hoàn toàn tình cờ ở sân bay ngày hôm qua."
      }
    ],
    "collocations": [
      "purely accidental",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Chúng tôi ngồi bên lò sưởi yên bình và tận hưởng một cuộc trò chuyện đầy cảm hứng về văn học."
      },
      {
        "en": "She struck up a casual conversation with the person sitting next to her.",
        "vi": "Cô bắt chuyện tự nhiên với người ngồi bên cạnh mình."
      }
    ],
    "collocations": [
  ...
  },
  {
    ...
    "oxfordExamples": [
      ...
      {
        "en": "Customer loyalty is critical to the sustained success of any retail brand.",
        "vi": "Lòng trung thành của khách hàng là yếu tố quyết định cho sự thành công lâu dài của bất kỳ thương hiệu bán lẻ nào."
      }
    ],
    "collocations": [
      "unwavering loyalty",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Công ty đã quyết định phát sóng một mẩu quảng cáo hấp dẫn trên truyền hình quốc gia vào khung giờ vàng."
      },
      {
        "en": "The new electric vehicle is a massive commercial success.",
        "vi": "Mẫu xe điện mới là một thành công thương mại khổng lồ."
      }
    ],
    "collocations": [
      "commercial TV ad",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Sau khi học tập dưới áp lực đè nặng suốt nhiều tuần, các sinh viên khao khát có vài ngày nghỉ ngơi bình yên."
      },
      {
        "en": "Many celebrities crave public attention and adoration.",
        "vi": "Nhiều người nổi tiếng luôn khao khát sự chú ý và tôn sùng của công chúng."
      }
    ],
    "collocations": [
      "crave attention",
  ...
  },
  {
    ...
    "oxfordExamples": [
      ...
      {
        "en": "I left my car at the local garage for its annual inspection.",
        "vi": "Tôi đã để xe tại gara địa phương để kiểm định hàng năm."
      }
    ],
    "collocations": [
      "park in the garage",
  ...
  },
  {
    ...
    "oxfordExamples": [
      ...
      {
        "en": "He swam safely across the calm lake.",
        "vi": "Anh ấy đã bơi an toàn qua hồ nước tĩnh lặng."
      }
    ],
    "collocations": [
      "across from",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Hàng ngàn du khách hào hứng tập trung để chứng kiến đoàn rước hoàng gia qua cổng cung điện."
      },
      {
        "en": "The royal family attended the grand ceremonial concert.",
        "vi": "Gia đình hoàng gia đã tham dự buổi hòa nhạc nghi lễ lớn."
      }
    ],
    "collocations": [
      "royal family",
  ...
  },
  {
    ...
    "oxfordExamples": [
      ...
      {
        "en": "The family attends church services together every Sunday morning.",
        "vi": "Gia đình cùng nhau tham dự các buổi lễ nhà thờ vào mỗi sáng Chủ nhật."
      }
    ],
    "collocations": [
      "go to church",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Có một tiệm bánh truyền thống đáng yêu nằm ngay ở góc đường Baker."
      },
      {
        "en": "The cafe is situated just around the corner from our school.",
        "vi": "Quán cà phê nằm ngay quanh góc phố gần trường học của chúng tôi."
      }
    ],
    "collocations": [
      "on / at the corner",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Nhiều người nghĩ anh ấy là lính mới, nhưng thực tế là anh ấy đã lập trình được mười năm rồi."
      },
      {
        "en": "As a matter of fact, I was just about to phone you.",
        "vi": "Thực ra thì tôi cũng vừa định nhấc máy gọi điện cho bạn đây."
      }
    ],
    "collocations": [
      "as a matter of fact",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Để giữ gìn sự hòa thuận và sạch sẽ, các bạn cùng phòng đại học đã đồng ý chia đều công việc nhà một cách công bằng."
      },
      {
        "en": "Couples who share out the housework report higher relationship satisfaction.",
        "vi": "Các cặp đôi cùng nhau san sẻ việc nhà thường có mức độ hài lòng về mối quan hệ cao hơn."
      }
    ],
    "collocations": [
      "share out chores",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Các phòng suite của khách sạn được tân trang lại bằng những tấm thảm Ba Tư cao cấp để giữ ấm cho sàn gỗ."
      },
      {
        "en": "Vacuuming the carpets regularly keeps allergens and dust under control.",
        "vi": "Hút bụi thảm thường xuyên giúp kiểm soát bụi bẩn và các tác nhân gây dị ứng."
      }
    ],
    "collocations": [
      "lay / vacuum a carpet",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Thuê căn hộ chung là giải pháp thiết thực cho sinh viên đại học với ngân sách eo hẹp."
      },
      {
        "en": "Living in a shared flat teaches you how to compromise and respect house rules.",
        "vi": "Sống trong một căn hộ chung rèn luyện cho bạn cách thỏa hiệp và tôn trọng nội quy chung."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Sau một thập kỷ làm việc nhiều giờ, cô ấy vô cùng phấn khởi khi cuối cùng đã mua được ngôi nhà của riêng mình."
      },
      {
        "en": "Do you own your apartment or do you rent it?",
        "vi": "Bạn sở hữu căn hộ này hay bạn đang đi thuê?"
      }
    ],
    "collocations": [
      "on one's own",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Khi pin điện thoại di động hết dọc đường, tôi đã dùng tiền xu để gọi về nhà từ một bốt điện thoại công cộng."
      },
      {
        "en": "Payphones have become a rare sight with the worldwide ubiquity of cellphones.",
        "vi": "Điện thoại công cộng đã trở thành hình ảnh hiếm hoi trước sự phổ biến toàn cầu của điện thoại di động."
      }
    ],
    "collocations": [
      "use a payphone",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Máy bán vé tự động ở lối vào ga tàu điện ngầm bị hỏng, vì vậy các hành khách đã mua tại quầy."
      },
      {
        "en": "The public elevator is temporarily out of order for maintenance.",
        "vi": "Thang máy công cộng tạm thời ngừng hoạt động để bảo trì."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Nếu bạn cần làm rõ thêm về giáo trình, vui lòng liên hệ với giảng viên của bạn."
      },
      {
        "en": "It was wonderful to get in touch with old classmates after twenty years.",
        "vi": "Thật tuyệt vời khi được kết nối lại với những người bạn cùng lớp cũ sau hai mươi năm."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Người thợ sửa xe đã mở mui xe ngay lập tức sau khi nghe thấy một tiếng ồn kỳ lạ phát ra từ động cơ."
      },
      {
        "en": "Late at night, they heard a peculiar noise coming from the attic.",
        "vi": "Đêm muộn, họ nghe thấy một tiếng động kỳ lạ vọng ra từ căn gác xép."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Hãng hàng không sẽ thông báo cho tất cả hành khách qua tin nhắn SMS nếu giờ khởi hành chuyến bay thay đổi."
      },
      {
        "en": "You must notify the authorities immediately if your passport is stolen.",
        "vi": "Bạn phải thông báo ngay cho cơ quan chức năng nếu hộ chiếu của bạn bị mất cắp."
      }
    ],
    "collocations": [
      "notify sb of sth",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Hiệu trưởng trường đại học đã bước lên bục giảng để công bố phát hiện nghiên cứu mang tính đột phá."
      },
      {
        "en": "The couple proudly announced their engagement to family and friends.",
        "vi": "Cặp đôi tự hào công bố việc đính hôn của họ với gia đình và bạn bè."
      }
    ],
    "collocations": [
      "officially announce",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Bảo tàng trưng bày một bộ sưu tập gốm tinh xảo từ thời kỳ Hy Lạp cổ điển."
      },
      {
        "en": "The trial probation period lasts for three calendar months.",
        "vi": "Thời gian thử việc kéo dài trong vòng ba tháng dương lịch."
      }
    ],
    "collocations": [
      "period of time",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Đánh giá từ những phản hồi tích cực của khách hàng, chiến dịch tiếp thị mới có vẻ rất thành công."
      },
      {
        "en": "It seems likely that interest rates will rise next quarter.",
        "vi": "Có vẻ như khả năng cao lãi suất sẽ tăng vào quý tới."
      }
    ],
    "collocations": [
      "it seems that",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Cô là một kiến trúc sư trẻ đầy tham vọng với mục tiêu thiết kế các tòa nhà chọc trời xanh bền vững trên toàn thế giới."
      },
      {
        "en": "The company outlined an ambitious five-year expansion plan.",
        "vi": "Công ty đã vạch ra một kế hoạch mở rộng đầy tham vọng kéo dài 5 năm."
      }
    ],
    "collocations": [
      "highly ambitious",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Ủy ban đã phải đưa ra một số quyết định khó khăn liên quan đến việc cắt giảm ngân sách giữa các phòng ban."
      },
      {
        "en": "He proved to be a tough negotiator during contract talks.",
        "vi": "Anh ấy đã chứng tỏ mình là một nhà đàm phán cứng rắn và bản lĩnh trong các cuộc đàm phán hợp đồng."
      }
    ],
    "collocations": [
      "tough decision",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Dù đối mặt với sự kiệt sức trầm trọng về thể lực, vận động viên marathon vẫn quyết tâm vượt qua vạch đích."
      },
      {
        "en": "She was determined to master English pronunciation within one year.",
        "vi": "Cô ấy đã kiên quyết làm chủ khả năng phát âm tiếng Anh trong vòng một năm."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Nhân viên bán xe đã giảm giá cho chúng tôi 5% so với giá niêm yết chính thức."
      },
      {
        "en": "Make sure you compare the listed price against competitor rates.",
        "vi": "Hãy chắc chắn bạn đã so sánh giá niêm yết với mức giá của đối thủ cạnh tranh."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Người mua sắm có thể tham khảo mức giá chuẩn của cục bảo vệ người tiêu dùng để kiểm tra xem giá thị trường có hợp lý hay không."
      },
      {
        "en": "The internal reference price helps managers set competitive product pricing.",
        "vi": "Mức giá tham khảo nội bộ giúp các nhà quản lý định giá sản phẩm cạnh tranh."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Trước khi bạn bắt đầu bấm số quốc tế, hãy đợi cho đến khi nghe thấy âm báo quay số rõ ràng."
      },
      {
        "en": "When she picked up the telephone receiver, there was no dial tone at all.",
        "vi": "Khi cô nhấc ống nghe điện thoại lên, hoàn toàn không có âm báo quay số nào cả."
      }
    ],
    "collocations": [
      "hear a dial tone",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Những người hàng xóm thân thiện của chúng tôi sống ngay đối diện bên kia đường, chỉ cách vài mét."
      },
      {
        "en": "I saw him standing outside the post office across the street.",
        "vi": "Tôi thấy anh ấy đang đứng bên ngoài bưu điện ở phía bên kia đường."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Nếu bạn chuẩn bị các lập luận một cách thấu đáo, bạn chắc chắn sẽ gây ấn tượng với hội đồng giám khảo."
      },
      {
        "en": "'Could you help me with this task?' — 'Certainly!'",
        "vi": "'Bạn có thể giúp tôi việc này được không?' — 'Chắc chắn rồi!'"
      }
    ],
    "collocations": [
      "almost certainly",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Trong văn hóa công ty nhịp độ nhanh của chúng tôi, chúng tôi cần một kiểu người linh hoạt thích nghi dễ dàng với những thay đổi."
      },
      {
        "en": "Being a flexible sort of person helps you handle unexpected travel disruptions calmly.",
        "vi": "Là một người linh hoạt sẽ giúp bạn xử lý những gián đoạn du lịch bất ngờ một cách bình tĩnh."
      }
    ],
    "collocations": [
      "a flexible person",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Khi mở bức thư trúng tuyển từ đại học Oxford, cô ấy không kìm được nụ cười toe toét tới tận mang tai."
      },
      {
        "en": "The boy was grinning from ear to ear after scoring his first goal.",
        "vi": "Cậu bé cười rạng rỡ hết cỡ sau khi ghi được bàn thắng đầu tiên."
      }
    ],
    "collocations": [
      "grin broadly",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Họ đã dành một ngày cuối tuần thư thái đi bộ đường dài qua vùng nông thôn tuyệt đẹp và chụp ảnh."
      },
      {
        "en": "Have a wonderful weekend and enjoy your time off!",
        "vi": "Chúc bạn một cuối tuần thật tuyệt vời và tận hưởng kỳ nghỉ ngơi nhé!"
      }
    ],
    "collocations": [
      "at / on the weekend",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Hầu hết các phòng khám y tế ở vùng ngoại ô đều đóng cửa vào các ngày cuối tuần, ngoại trừ phòng cấp cứu."
      },
      {
        "en": "I usually play tennis on weekends with friends.",
        "vi": "Tôi thường chơi quần vợt vào các ngày cuối tuần cùng bạn bè."
      }
    ],
    "collocations": [
      "open on weekends",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Nhóm phần mềm của chúng tôi triển khai các bản phát hành phần mềm mới vào mỗi chiều thứ Sáu trước giờ tan sở."
      },
      {
        "en": "Are you free for lunch this coming Friday?",
        "vi": "Thứ Sáu tới này bạn có rảnh đi ăn trưa không?"
      }
    ],
    "collocations": [
      "on Friday",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Chợ hoa ngoài trời sôi động diễn ra ở quảng trường thị trấn vào mỗi sáng thứ Bảy."
      },
      {
        "en": "We are hosting a family barbecue on Saturday afternoon.",
        "vi": "Chúng tôi sẽ tổ chức một bữa tiệc thịt nướng gia đình vào chiều thứ Bảy."
      }
    ],
    "collocations": [
      "on Saturday",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Nâng tạ và nạp đủ protein giúp thúc đẩy sự phát triển và phục hồi cơ bắp săn chắc."
      },
      {
        "en": "He pulled a hamstring muscle while sprinting towards the ball.",
        "vi": "Anh ấy bị căng cơ đùi sau khi đang chạy nước rút về phía quả bóng."
      }
    ],
    "collocations": [
      "build muscle",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Bất kỳ ai bị đau ngực dữ dội đột ngột nên liên hệ ngay với các dịch vụ y tế khẩn cấp."
      },
      {
        "en": "The doctor asked detailed questions about the onset and duration of the chest pain.",
        "vi": "Bác sĩ đã đặt những câu hỏi chi tiết về thời điểm bắt đầu và thời gian kéo dài của cơn đau ngực."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Hãy chắc chắn rằng bạn lắp ráp dây đai an toàn đúng cách trước khi thử leo núi."
      },
      {
        "en": "The machine will not function properly if not cleaned regularly.",
        "vi": "Chiếc máy sẽ không hoạt động bình thường đúng cách nếu không được vệ sinh định kỳ."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Các bác sĩ tim mạch khuyến cáo mạnh mẽ người trưởng thành nên tập thể dục đều đặn để duy trì trái tim khỏe mạnh."
      },
      {
        "en": "We meet regularly every month to discuss team progress.",
        "vi": "Chúng tôi họp đều đặn hàng tháng để thảo luận về tiến độ của nhóm."
      }
    ],
    "collocations": [
      "exercise regularly",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Húng tây ngọt tươi và dầu ô liu nguyên chất là những nguyên liệu thiết yếu trong sốt pesto chuẩn vị."
      },
      {
        "en": "Check the list of ingredients on the package for potential food allergens.",
        "vi": "Kiểm tra danh sách thành phần nguyên liệu trên bao bì để phát hiện các chất dễ gây dị ứng thực phẩm."
      }
    ],
    "collocations": [
      "fresh ingredients",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Bác sĩ đã kê một đợt thuốc kháng sinh đầy đủ để loại bỏ tình trạng nhiễm trùng vi khuẩn cấp tính."
      },
      {
        "en": "It is crucial to finish the entire prescribed course of antibiotics.",
        "vi": "Điều tối quan trọng là phải uống hết toàn bộ liều kháng sinh được bác sĩ chỉ định."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Cô đã uống một viên thuốc giảm đau nhẹ để làm dịu cơn đau đầu nhức nhối xuất hiện sau giờ làm việc."
      },
      {
        "en": "Over-the-counter painkillers can help manage mild sports injuries.",
        "vi": "Các loại thuốc giảm đau không kê đơn có thể giúp kiểm soát các chấn thương thể thao nhẹ."
      }
    ],
    "collocations": [
      "take a painkiller",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Các nhà nghiên cứu y học trên toàn cầu đang nỗ lực tìm kiếm phương thuốc chữa khỏi hoàn toàn cho các bệnh ung thư phổ biến."
      },
      {
        "en": "Prevention is universally acknowledged as better than cure.",
        "vi": "Phòng bệnh luôn luôn tốt hơn chữa bệnh."
      }
    ],
    "collocations": [
      "cure a disease",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Rửa tay thường xuyên bằng xà phòng và nước ấm giúp ngăn ngừa các bệnh nhiễm trùng vi khuẩn nguy hiểm."
      },
      {
        "en": "The wound was thoroughly cleaned and disinfected to ward off infections.",
        "vi": "Vết thương đã được làm sạch và sát trùng kỹ lưỡng để phòng tránh nhiễm trùng."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Ăn phải hải sản nhiễm khuẩn đã gây ra đau bụng dữ dội và ngộ độc thực phẩm cấp tính."
      },
      {
        "en": "Always cook chicken thoroughly to prevent the risk of food poisoning.",
        "vi": "Luôn nấu chín thịt gà kỹ lưỡng để ngăn ngừa nguy cơ ngộ độc thực phẩm."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Mỗi mùa thu, người cao tuổi đều được khuyến khích tiêm vắc-xin phòng ngừa bệnh cúm mùa."
      },
      {
        "en": "He caught the flu and had to stay in bed with a high fever for four days.",
        "vi": "Anh ấy bị cúm và phải nằm bẹp trên giường với cơn sốt cao suốt bốn ngày."
      }
    ],
    "collocations": [
  ...
  },
  {
    ...
    "oxfordExamples": [
      ...
      {
        "en": "Regular physical exercise can significantly reduce the risk of developing diabetes.",
        "vi": "Tập thể dục thường xuyên có thể làm giảm đáng kể nguy cơ phát triển bệnh tiểu đường."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Phát hiện lâm sàng sớm làm tăng đáng kể tỷ lệ sống sót cho bệnh nhân được chẩn đoán mắc bệnh ung thư vú."
      },
      {
        "en": "He has dedicated his scientific career to cancer research.",
        "vi": "Ông đã cống hiến sự nghiệp khoa học của mình cho công trình nghiên cứu ung thư."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Một cơn ho mãn tính kéo dài hơn ba tuần kèm theo đổ mồ hôi ban đêm có thể là dấu hiệu của bệnh lao thể hoạt động."
      },
      {
        "en": "Public health initiatives have made massive progress in treating tuberculosis worldwide.",
        "vi": "Các sáng kiến y tế công cộng đã đạt được tiến bộ to lớn trong việc điều trị bệnh lao trên toàn thế giới."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Sự kiên nhẫn và lắng nghe tích cực sẽ luôn là chìa khóa then chốt để xây dựng những mối quan hệ bền lâu."
      },
      {
        "en": "Continuous practice is the key to fluency in any foreign language.",
        "vi": "Luyện tập liên tục chính là chìa khóa để trôi chảy trong bất kỳ ngôn ngữ nào."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Ngay khi bước vào tiệm bánh Pháp thủ công, chúng tôi đã ngửi thấy mùi bánh mì mới nướng thơm phức."
      },
      {
        "en": "Nothing beats the comforting taste of freshly baked bread with creamy butter.",
        "vi": "Không gì sánh bằng hương vị ấm lòng của bánh mì mới nướng quết bơ béo ngậy."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Hạt cà phê espresso rang đậm tươi mới đã làm ngập tràn căn phòng một mùi thơm nồng nàn tuyệt vời."
      },
      {
        "en": "The beef stew simmered gently, releasing a rich aroma of herbs and garlic.",
        "vi": "Món thịt bò hầm liu riu, tỏa ra mùi thơm ngào ngạt của thảo mộc và tỏi."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Chuyến tàu cao tốc mới đã rút ngắn thời gian di chuyển giữa các thành phố một cách đáng kể."
      },
      {
        "en": "Living expenses in metropolitan areas have risen considerably over the past decade.",
        "vi": "Chi phí sinh hoạt ở các khu vực đô thị lớn đã tăng lên khá nhiều trong thập kỷ qua."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Các nhà hoạt động môi trường đã tổ chức một chiến dịch cộng đồng đầy cảm hứng nhằm giảm thiểu cốc nhựa dùng một lần."
      },
      {
        "en": "The advertising campaign led to a thirty percent surge in online subscriptions.",
        "vi": "Chiến dịch quảng cáo đã dẫn đến sự gia tăng ba mươi phần trăm lượng đăng ký trực tuyến."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Trước khi ký bất kỳ hợp đồng thuê thương mại ràng buộc nào, việc tham khảo ý kiến luật sư bất động sản giàu kinh nghiệm là rất khôn ngoan."
      },
      {
        "en": "You should always consult your physician before starting an intensive workout routine.",
        "vi": "Bạn nên luôn tham khảo ý kiến bác sĩ trước khi bắt đầu một chế độ tập luyện cường độ cao."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Các nghiên cứu chỉ ra rằng hoạt động thể chất thường xuyên và chế độ ăn cân bằng đóng góp trực tiếp vào sự trường thọ của con người."
      },
      {
        "en": "The durability and longevity of leather shoes make them a worthwhile investment.",
        "vi": "Độ bền và tuổi thọ sử dụng lâu dài của giày da khiến chúng trở thành một khoản đầu tư xứng đáng."
      }
    ],
    "collocations": [
      "promote longevity",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Duy trì sự tò mò học hỏi và vận động thể chất giúp làm chậm lại quá trình lão hóa tự nhiên."
      },
      {
        "en": "Many developed nations are facing socioeconomic challenges due to an ageing population.",
        "vi": "Nhiều quốc gia phát triển đang đối mặt với những thách thức kinh tế xã hội do dân số già hóa."
      }
    ],
    "collocations": [
      "process of ageing",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Một tỷ lệ đáng kể người dùng máy tính bàn bị mắc chứng đau mỏi cứng cổ vai gáy mãn tính."
      },
      {
        "en": "Millions of individuals suffer from seasonal allergies each spring.",
        "vi": "Hàng triệu cá nhân phải chịu đựng bệnh dị ứng thời tiết vào mỗi mùa xuân."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Tình trạng thiếu ngủ nghiêm trọng làm suy giảm nặng nề khả năng điều hòa cảm xúc, sự tập trung và khả năng ra quyết định."
      },
      {
        "en": "Children raised in conditions of extreme economic deprivation face higher health vulnerabilities.",
        "vi": "Trẻ em lớn lên trong điều kiện thiếu thốn kinh tế cùng cực đối mặt với nhiều rủi ro sức khỏe hơn."
      }
    ],
    "collocations": [
      "sleep deprivation",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Đội ngũ cứu thương khẩn cấp đã đến nơi ngay lập tức trong vòng bốn phút sau cuộc gọi điện thoại."
      },
      {
        "en": "Please ensure that customer complaints are resolved promptly and politely.",
        "vi": "Vui lòng đảm bảo rằng các khiếu nại của khách hàng được giải quyết kịp thời và lịch sự."
      }
    ],
    "collocations": [
      "arrive promptly",
  ...
  },
  {
    ...
    "oxfordExamples": [
      ...
      {
        "en": "The patient was prescribed daily medication to regulate her high blood pressure.",
        "vi": "Bệnh nhân được kê đơn thuốc uống hàng ngày để điều hòa huyết áp cao."
      }
    ],
    "collocations": [
      "take medication",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Bác sĩ có thể hỗ trợ giảm nhẹ cơn đau, nhưng đáng buồn là căn bệnh thoái hóa giai đoạn cuối này hiện không thể chữa khỏi."
      },
      {
        "en": "He is an incurable romantic who still sends handwritten love letters.",
        "vi": "Anh ấy là một kẻ lãng mạn hết thuốc chữa, người vẫn gửi những lá thư tình viết tay."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Giao tiếp rõ ràng giữa các phi công và kiểm soát viên không lưu đóng một vai trò tối quan trọng đối với an toàn hàng không."
      },
      {
        "en": "Drinking clean water is vital for maintaining optimal bodily functions.",
        "vi": "Uống nước sạch là điều sống còn để duy trì các chức năng cơ thể tối ưu."
      }
    ],
    "collocations": [
      "play a vital role",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Bài phát biểu tưởng niệm chân thành đã bày tỏ nỗi buồn và sự đau xót tột cùng đối với những nạn nhân vô tội của thảm họa."
      },
      {
        "en": "Time gradually healed the deep sorrow left by his grandfather's passing.",
        "vi": "Thời gian dần dần xoa dịu nỗi đau buồn sâu sắc mà sự ra đi của người ông để lại."
      }
    ],
    "collocations": [
      "deep / overwhelming sorrow",
      "express sorrow",
      "tears of sorrow",
      "share one's sorrow"
    ],
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Anh ấy trông rất bảnh bao khi mặc chiếc áo khoác thể thao vải tweed vừa vặn cùng quần âu màu be tới buổi chiêu đãi."
      },
      {
        "en": "A navy sports jacket paired with chinos is the classic smart-casual look.",
        "vi": "Một chiếc áo khoác blazer thể thao màu xanh navy kết hợp cùng quần chinos là diện mạo bán trang trọng kinh điển."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Sau ca làm việc mệt mỏi mười sáu tiếng tại bệnh viện chấn thương bận rộn, các y tá đã mệt rã rời không còn chút sức lực."
      },
      {
        "en": "I'm beat — I think I'll head straight to bed early tonight.",
        "vi": "Tôi mệt lử cả người rồi — chắc tối nay tôi sẽ đi ngủ sớm luôn đây."
      }
    ],
    "collocations": [
      "dead beat",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Hành khách phải gắn thẻ nhận dạng có ghi số điện thoại liên lạc vào tất cả hành lý ký gửi."
      },
      {
        "en": "They carried their heavy luggage up three flights of stairs to their hotel room.",
        "vi": "Họ mang đống hành lý nặng nề lên ba tầng cầu thang để về phòng khách sạn."
      }
    ],
    "collocations": [
      "piece of luggage",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Xin lưu ý rằng việc gọi đồ ăn phục vụ tại phòng khách sạn sau nửa đêm sẽ phải chịu một khoản phụ phí mười đô la."
      },
      {
        "en": "Large baggage exceeding twenty kilograms is subject to an extra charge at check-in.",
        "vi": "Hành lý kích thước lớn vượt quá hai mươi kg sẽ phải chịu thêm phụ phí khi làm thủ tục."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Tôi thích đặt ghế ngồi cạnh lối đi trên các chuyến bay đường dài để có thể dễ dàng đứng dậy mà không làm phiền người khác."
      },
      {
        "en": "The flight attendant helped the elderly gentleman take his assigned aisle seat.",
        "vi": "Tiếp viên hàng không đã tận tình giúp cụ ông ngồi vào chiếc ghế cạnh lối đi được phân công."
      }
    ],
    "collocations": [
      "book an aisle seat",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Khi qua biên giới quốc tế, du khách phải khai báo hải quan bất kỳ mặt hàng rượu hoặc thuốc lá chịu thuế nào."
      },
      {
        "en": "The referee officially declared the young contender the winner by knockout.",
        "vi": "Trọng tài đã chính thức tuyên bố võ sĩ trẻ tuổi là người chiến thắng bằng đòn hạ đo ván."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Các cảnh báo sức khỏe cộng đồng nhấn mạnh những nguy cơ nghiêm trọng của bệnh ung thư phổi liên quan đến việc hút thuốc lá."
      },
      {
        "en": "He resolved to quit smoking cigarettes for the sake of his newborn child.",
        "vi": "Anh ấy đã quyết tâm bỏ hút thuốc lá vì tương lai của đứa con mới chào đời."
      }
    ],
    "collocations": [
      "pack of cigarettes",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Cô ấy chấm nhẹ vài giọt nước hoa hương hoa của Pháp sau mỗi bên tai trước khi bước ra ngoài."
      },
      {
        "en": "The subtle perfume of jasmine filled the evening garden breeze.",
        "vi": "Hương thơm thoang thoảng của hoa nhài ngập tràn trong làn gió vườn buổi tối."
      }
    ],
    "collocations": [
      "wear / spray perfume",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Xin thứ lỗi, thầy có thể vui lòng nhắc lại câu cuối cùng của bài giảng được không ạ?"
      },
      {
        "en": "'Pardon?' she said, leaning forward to hear better above the crowd noise.",
        "vi": "'Xin lỗi, bạn nói gì cơ?' cô ấy nói và nghiêng người về phía trước để nghe rõ hơn giữa tiếng ồn."
      }
    ],
    "collocations": [
      "beg your pardon",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Phòng khiêu vũ tràn ngập những vị khách quý diện những bộ trang phục dạ hội thanh lịch và sang trọng."
      },
      {
        "en": "The mathematician proposed an exceptionally elegant solution to the equation.",
        "vi": "Nhà toán học đã đề xuất một giải pháp cực kỳ tao nhã và chuẩn xác cho phương trình."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Chú chó con golden lông xù bé xíu hào hứng vẫy đuôi trông đáng yêu và dễ thương hết nấc."
      },
      {
        "en": "Their two-year-old daughter is as cute as a button with her bright dimples.",
        "vi": "Cô con gái hai tuổi của họ dễ thương hết sảy với đôi má lúm đồng tiền rạng rỡ."
      }
    ],
    "collocations": [
      "cute as a button",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Xì gà Cuba truyền thống nổi tiếng khắp thế giới nhờ hương vị đậm đà và kỹ nghệ cuốn tay thủ công tinh xảo."
      },
      {
        "en": "He lit up a vintage cigar to celebrate the sealing of the lucrative business deal.",
        "vi": "Ông châm một điếu xì gà hảo hạng để ăn mừng việc hoàn tất thỏa thuận kinh doanh béo bở."
      }
    ],
    "collocations": [
      "smoke a cigar",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Cô cảm thấy ghen tị thầm kín khi biết người bạn thân nhất của mình đã giành được học bổng danh giá."
      },
      {
        "en": "Try not to become jealous of other people's good fortunes; focus on your own growth.",
        "vi": "Đừng ghen tị với vận may của người khác; hãy tập trung vào sự phát triển của chính bạn."
      }
    ],
    "collocations": [
      "jealous of somebody",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Tôi cá mười đô la rằng đội bóng trường chúng ta sẽ giành chiến thắng trong trận chung kết tối nay."
      },
      {
        "en": "I bet you were surprised when you heard the big announcement.",
        "vi": "Tôi dám chắc là bạn đã rất ngạc nhiên khi nghe thấy thông báo lớn đó."
      }
    ],
    "collocations": [
      "place a bet",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Món gà nướng được dọn ăn kèm đậu Hà Lan hấp và một bát khoai tây nghiền béo ngậy thơm ngon."
      },
      {
        "en": "Warm gravy poured over homemade mashed potatoes is comfort food at its best.",
        "vi": "Nước sốt thịt ấm nóng rưới lên khoai tây nghiền tự làm là món ăn mang lại cảm giác dễ chịu tuyệt vời nhất."
      }
    ],
    "collocations": [
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Thư ký điều hành phụ trách quản lý lịch trình hàng ngày, đặt vé máy bay và lưu trữ hồ sơ mật của tổng giám đốc."
      },
      {
        "en": "Please check in with the department secretary when you arrive for the interview.",
        "vi": "Vui lòng làm thủ tục với thư ký khoa khi bạn đến tham dự buổi phỏng vấn."
      }
    ],
    "collocations": [
      "executive secretary",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Người bồi bàn nữ lịch sự đã rót nước đá vào ly của chúng tôi và ghi lại các món ăn tối một cách nhanh chóng."
      },
      {
        "en": "We left a generous twenty percent tip for the attentive waitress.",
        "vi": "Chúng tôi đã để lại tiền boa hào phóng hai mươi phần trăm cho người phục vụ bàn chu đáo."
      }
    ],
    "collocations": [
      "work as a waitress",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Người làm vườn mang kéo tỉa lớn ra vào mỗi mùa thu để cắt tỉa các bụi cây dọc theo hàng rào vườn."
      },
      {
        "en": "Trimming the bushes allows more morning sunlight to reach the flowerbeds.",
        "vi": "Việc cắt tỉa bụi rậm giúp ánh nắng ban mai chiếu tới các luống hoa nhiều hơn."
      }
    ],
    "collocations": [
  ...
  },
  {
    ...
    "oxfordExamples": [
      ...
      {
        "en": "Weeding the flower beds prevents invasive plants from choking tender blossoms.",
        "vi": "Làm cỏ cho luống hoa giúp ngăn chặn cỏ dại xâm lấn bóp nghẹt những bông hoa mỏng manh."
      }
    ],
    "collocations": [
      "weed the garden",
    ...
    "oxfordExamples": [
      {
        ...
        "vi": "Thanh tra xây dựng kết luận rằng các lối thoát hiểm khi hỏa hoạn đều ở trong tình trạng hoàn toàn đạt yêu cầu."
      },
      {
        "en": "We reached a mutually satisfactory agreement after lengthy negotiations.",
        "vi": "Chúng tôi đã đạt được một thỏa thuận đôi bên cùng thỏa đáng sau các cuộc đàm phán kéo dài."
      }
    ],
    "collocations": [
